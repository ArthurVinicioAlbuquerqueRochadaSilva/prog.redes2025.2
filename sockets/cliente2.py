...
strMensagemEntrada = socket.gethostbyname(socket.gethostname()) + 'CONECTADO'
sockClient.sendto(strMensagemEntrada.encode(constantes.CODE_PAGE), constantes.TUPLA_SERVER)
